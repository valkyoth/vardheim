...
| `0.26.0-0.31.1` | HTTP-01, dedicated `vardheim-pkix`, CSR, X.509/PKIX verification, OCSP/CRL/CT acquisition, alternate chains and selection policy |
...
| `0.40.0-0.51.3` | ARI, emergency key-compromise response, DNS query semantics, DNS-01/DNSSEC/providers/agent, TLS-ALPN-01, rustls, OpenSSL presentation, and web-server challenge acceptance |
| `0.52.0-0.66.2` | transports, key roles, RustCrypto, ring, aws-lc-rs, FIPS, PKCS#11, TPM2, KMS, remote signing, and offline rollover ceremony |
...
| `0.82.0-0.91.2` | SQLite/PostgreSQL, tenancy, deployers, audit, CLI, daemon, agents, and agent upgrade compatibility |
