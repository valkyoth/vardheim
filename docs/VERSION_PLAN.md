...
| `0.5.0-0.13.1` | budgets and early Kani, transient evidence/trust types, errors, bounded JSON and differential fuzzing, base64url, JWK/JWA, provider-neutral digest/sign/verify/entropy/key-generation/TSIG-MAC and purpose-bound legacy-hash semantics, bounded JWS, EAB, rollover, nonces and Loom |
...
| `0.26.0-0.31.3` | HTTP-01, DER/CSR/TLS Feature, private test crypto/status/CT/DNSSEC/TSIG, issued-trust snapshots, dedicated PKIX/full RFC 5280, chain-wide OCSP/CRL, distinct CT v1/v2, hardened acquisition/AIA, alternate chains, and context evidence |
...
| `0.40.0-0.51.5` | ARI, compromise/lifecycle facade, status/Must-Staple, DNS/EDNS/source-port/TCP/Cookies plus DNSSEC/NSEC/NSEC3, RFC 2136/TSIG contracts, providers/agent, TLS-ALPN-01, rustls/OpenSSL stapling, and web-server acceptance |
| `0.52.0-0.66.2` | ACME/public-PKI transports with framing/privacy/cache isolation, custom/platform issued trust, legacy-key migration, purpose-specific crypto, RustCrypto EAB/RSA-PSS/legacy/DNSSEC/TSIG, production RFC 2136, ring/aws-lc/FIPS capability tables, hardware/KMS/remote signing |
