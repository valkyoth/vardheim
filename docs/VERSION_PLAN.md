...
| `0.26.0-0.31.3` | HTTP-01, DER/CSR/TLS Feature, private test crypto/status/CT/DNSSEC/TSIG, issued-trust snapshots, dedicated PKIX/full RFC 5280, local OCSP/CRL/SCT, acquisition/AIA, alternate chains, and context evidence |
...
| `0.40.0-0.51.5` | ARI, compromise/lifecycle facade, status/Must-Staple, DNS/EDNS plus DNSSEC/NSEC/NSEC3, RFC 2136/TSIG contracts, providers/agent, TLS-ALPN-01, rustls/OpenSSL stapling, and web-server acceptance |
| `0.52.0-0.66.2` | ACME/public-PKI transports, custom/platform issued trust, purpose-specific crypto, RustCrypto EAB/RSA-PSS/legacy/DNSSEC/TSIG, production RFC 2136, ring, aws-lc-rs, FIPS, hardware/KMS/remote signing |
